---
title: "Jenkins + Vue 自动化部署实战指南：从代码提交到 Nginx 上线"
date: "2026-01-25"
description: "手把手教你配置 Jenkins 流水线，实现 Vue 前端项目的自动化构建与 SSH 部署。包含 Node环境配置、Nginx 权限设置及常见坑点解析。"
tags: ["DevOps", "Jenkins", "Vue.js", "CI/CD", "Nginx", "Frontend Automation"]
---
